export const translations = {
  ...
  it: {
    slide1:
      'CoTrack ti avvisa in tempo reale se sei stato in stretto contatto con una persona infetta',
    slide2:
    ...
    IfSymptomsChanged: 'Se i sintomi stavano cambiando, ripetere l\' autovalutazione e seguito le raccomandazioni fornite.',
    ...
    inmunosuppresion: 'Immunodepressione',
    diabetes: 'Diabete',
    cancer: 'Tumore',
    hepatic: 'Insufficienza epatica',
    pregnant: 'Gravidanza',
    newborn: 'Neonato',
    respiratoryDisease: 'Malattie respiratorie (e.g. Asma)',
    kidneyDisease: 'Insufficienza renale',
    cardiologicalDisease: 'Malattia Cardiache - Ipertensione',
